 ...
 */
public class PartialParse<T extends Token> implements Scored {

	private List<T> targetTokens = new ArrayList<T>();
	 ...
	 * @param lispTree
	 */
	protected PartialParse(List<T> sourceInputTokens, int startIndex, int endIndex, T sourceLhs,
	...
	// * @param scores
	// */
	// protected Parse(List<T> sourceInputTokens, int startIndex, int endIndex,
	// T sourceTerminal,
	 ...
	 * @param scores
	 */
	protected PartialParse(List<T> sourceInputTokens, List<T> targetTerminals, T targetTerminal) {
	 ...
	 * @param other
	 */
	public PartialParse(PartialParse<T> other) {
	...
	public void addRecombinedParse(PartialParse<T> parse) {
		// TODO: XXX: Track this!
	}

	public List<PartialParse<T>> getRecombinedParses() {
		return new ArrayList<PartialParse<T>>(0);
	}
	...
	public void appendParse(int sourceRhsIndex, int targetRhsIndex, PartialParse<T> parse) {
	...
	public void prependTargetTerminal(T terminal) {
		
	}
	
	public void appendTargetTerminal(T terminal) {
	...
	public String toString(TreeFormatter<T> formatter) {
		return targetTree.toString(formatter);
	}
}
