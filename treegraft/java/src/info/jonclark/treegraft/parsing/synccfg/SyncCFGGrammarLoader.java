...
public class SyncCFGGrammarLoader<T extends Token> implements GrammarLoader<SyncCFGRule<T>, T> {
	...
	public SyncCFGGrammarLoader(TokenFactory<T> tokenFactory) {
	 ...
	 */
	public void loadGrammar(Grammar<SyncCFGRule<T>, T> grammar, InputStream stream, String inputSourceName,
