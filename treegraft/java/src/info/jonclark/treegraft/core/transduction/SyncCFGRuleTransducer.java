...
//			transducedWord = sourceKey.getRules().getLhs();
//		} else if (type == OutputType.TARGET) {
//			transducedWord = sourceKey.getRules().getTargetLhs();
//		} else {
...
//							sourceArc.getEndIndex(), sourceKey.getRules(), transducedWord);
//		} else {
//
//			List<Vertex<SyncCFGRule<T>, T>>[] children;
//			if (type == OutputType.SOURCE) {
//				children = new List[sourceKey.getRules().getRhs().length];
//			} else {
//				children = new List[sourceKey.getRules().getTargetRhs().length];
//			}
...
//			target =
//					new Vertex<SyncCFGRule<T>, T>(sourceArc.getStartIndex(),
//							sourceArc.getEndIndex(), sourceKey.getRules(), transducedWord, children);
//		}
//
//		return target;
